import { Phone, Play, Shield, Star, CheckCircle } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            ...
            {/* Floating Stats */}
            <div className="absolute -bottom-4 -left-4 bg-trust-blue text-primary-foreground px-5 py-3 rounded-xl shadow-lg">
              <div className="text-2xl font-black">22+</div>
              <div className="text-xs font-semibold opacity-90">Years Experience</div>
            </div>

            <div className="absolute -bottom-4 -right-4 bg-accent text-accent-foreground px-5 py-3 rounded-xl shadow-lg">
