      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((s) => (
            <div
              key={s.title}
              className="bg-card p-5 rounded-xl border-2 border-foreground/15 hover:border-accent shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden"
            >
              {/* Accent top bar */}
